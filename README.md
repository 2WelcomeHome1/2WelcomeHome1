...
Я Senior+ / Tech Lead Machine Learning Engineer с 5+ годами опыта построения end-to-end ML-систем, приносящих измеримый бизнес-эффект. Специализируюсь на архитектуре решений в доменах CV + LLM/Agents: от стратегии до продакшена. Автор научных публикаций по Computer Vision и эффективным архитектурам сегментации.
